...
public class SphereFader : MonoBehaviour
{
    ...
    public GameObject mainSpheremap, leftSpheremap, rightSpheremap;
    ...
    void Start()
    {
        ...
        mainSpheremap = this.gameObject;

        NumberOfImages = mainSpheremap.GetComponent<SphereMapProperties>().imagesPerEye;
    ...
    void Update()
    {
        ...
        CurrentDegree = GameObject.FindGameObjectWithTag("MainCamera").transform.eulerAngles.y;
    ...
    void GetSphereMapObjects()
    {
        ...
        Debug.Log("Left Sphere Map childs = " + childInSpheremap);
